...
Leo.DrawRectangleHandler = Leo.Handler.extend({
  ...
  mousemove: function(element, event) {
    ...
    this.node.lineTo(pos.left, this.start.top);
    this.node.lineTo(pos.left, pos.top);
    this.node.lineTo(this.start.left, pos.top);
    this.node.lineTo(this.start.left, this.start.top);
