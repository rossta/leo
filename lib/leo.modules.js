Leo.Module = Base.extend({
  ...
  notifyLeo: function(data) {
    var _this = this;
    return function(e) { return $leo.notify(e.type, _this.position(this, e), data); }; 
  },
...
Leo.View = (function() {
  ...
  var instanceMethods = {
    ...
    selectNode: function(pos) {
      var x = pos.left, y = pos.top,
      node = this.root.nodeAt(pos);
