AC.Painter = (function() {
  var publicMethods = {
    ...
    constructor: function() {
      this.extend(new AC.Canvas($("#painter")));
    ...
    brushChanged: function(brush) {
      AC.Logger.log(this, "brushChanged", brush);
      this.brush = brush;
    },
    ...
    drawing: {
      rectangle: function(context) {
        ...
        AC.Drawing.rectangle(this.startPos, this.curPos, context);
        return this;
      },
      ...
      circle: function (context) {
        context = context || this.contextClone;
        this.clearCanvas(this.contextClone);
        AC.Drawing.circle(this.startPos, this.curPos, context);
        return this;
      },
      ...
      line: function(context) {
        context = context || this.contextClone;
        this.clearCanvas(this.contextClone);
        AC.Drawing.path(this.startPos, this.curPos, context);
        return this;
      },
      ...
      brush: function(context) {
        context = context || this.context;
        AC.Drawing.path(this.startPos, this.curPos, this.context);
        this.startPos = this.curPos;
        return this;
      }
    }
  ...
  initializeBrushes = function() {
    this.brushPicker = AC.BrushPicker.create(this);
  },
